...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar ftco-navbar-light site-navbar-target" id="ftco-navbar">
        <div class="container">
            <a class="navbar-brand" href="index.html"><span>O</span>uMaima</a>
                    ...
                    <div class="text text-center">
                        ...
                        <h2>I'm a
                            <span class="txt-rotate" data-period="100"
                                data-rotate='[ "Full Stack Developer.", "Social Media Manager.", "Marketer.", "Content Creator" ]'></span>
                        </h2>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 col-lg-6 d-flex">
                    <div class="img-about img d-flex align-items-stretch">
                        ...
                        <div class="img d-flex align-self-stretch align-items-center"
                            style="background-image:url(images/omaima.jpg);">
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 pl-md-5 py-5">
                    <div class="row justify-content-start pb-3">
                        <div class="col-md-12 heading-section ftco-animate">
                            ...
                            <p>Je suis oumaima,passionnée par le monde du développement web et de la technologie, je suis une individuelle dynamique et créative, toujours à la recherche de nouvelles façons d'innover et de résoudre des problèmes. Dotée d'une curiosité insatiable et d'une volonté inébranlable d'apprendre, je m'efforce constamment de repousser mes limites,
                    ...
                    <script>
                        fetch('/api/info')
                            ...
                            .then(data => {
                                ...
                                <li class="d-flex"><span>Address:</span> <span>${data[0].adresse}</span></li>
                                <li class="d-flex"><span>Phone:</span> <span>${data[0].telephone}</span></li>
                                <li class="d-flex"><span>Email:</span> <span>${data[0].email}</span></li>
                            `;
                            })
                            ...
                            .then(data => {
                                ...
                                data.forEach(education => {
                                    ...
                                    formationDiv.innerHTML = `
                                        ...
                                        <div class="text pl-3">
                                            <span class="date">${education.annee_obtention}</span>
                                            <h2>${education.diplome}</h2>
                                            <span class="position">${education.etablissement}</span>
                                            <p>${education.lieu}</p>
                                        </div>
                                    `;
